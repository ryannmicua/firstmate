...
# fm_backend_required_tools (bin/fm-backend.sh). So a herdr/zellij/cmux/paseo home
# is never told tmux is missing, and orca and paseo drop treehouse. A backend value with
